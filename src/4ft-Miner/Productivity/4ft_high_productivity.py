...
# На всякий случай приводим всё к строкам
...
# Сначала по confidence, потом по aad, потом по base
filtered_rules.sort(
...
cz_text = (
    "Analýza pomocí 4ft-Miner ukázala, že vysoká změna produktivity nejčastěji souvisí "
    "s kombinací několika pokročilých charakteristik firmy. Nejsilnější pravidla se objevila "
    "u firem s vysokou úrovní školení zaměstnanců v oblasti AI, vysokým počtem aktivních AI projektů "
    "a zároveň vysokou mírou automatizace nebo vysokým AI rozpočtem. Tyto kombinace dosahují velmi "
    "vysoké hodnoty confidence, přibližně 90 až 95 %, což znamená, že v těchto skupinách firem je "
    "vysoká produktivita velmi častá. Výsledky tedy naznačují, že samotné zavedení AI nestačí, "
    "ale klíčová je hlubší implementace podpořená školením, investicemi a praktickým využitím v projektech."
)
